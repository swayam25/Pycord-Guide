...
<DiscordComponent messages={[[PrefixedHelpUserMsgPayload], [PrefixedHelpMinimalEmbed]]} />
...
<DiscordComponent messages={[[PrefixedHelpUserMsgErrorEmbed], [PrefixedHelpErrorEmbed]]} />
