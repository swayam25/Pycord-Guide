...
import FeedbackResponsePayload from "@payloads/popular-topics/error-handling/feedback-response.json";
import FeedbackUserMessagePayload from "@payloads/popular-topics/error-handling/feedback-user-message.json";
import FeedbackThanksPayload from "@payloads/popular-topics/error-handling/feedback-thanks.json";
import FeedbackTimeoutResponsePayload from "@payloads/popular-topics/error-handling/feedback-timeout-response.json";
import FeedbackTimeoutErrorPayload from "@payloads/popular-topics/error-handling/feedback-timeout-error.json";
import SecretOwnerResponsePayload from "@payloads/popular-topics/error-handling/secret-owner-response.json";
import SecretNonOwnerResponsePayload from "@payloads/popular-topics/error-handling/secret-non-owner-response.json";
import AvatarDmUserMsgPayload from "@payloads/popular-topics/error-handling/avatar-dm-user-msg.json";
import AvatarDmResponsePayload from "@payloads/popular-topics/error-handling/avatar-dm-response.json";
import AvatarGuildUserMsgPayload from "@payloads/popular-topics/error-handling/avatar-guild-user-msg.json";
import AvatarGuildErrorPayload from "@payloads/popular-topics/error-handling/avatar-guild-error.json";
import PingCooldownFirstPayload from "@payloads/popular-topics/error-handling/ping-cooldown-first.json";
import PingCooldownErrorPayload from "@payloads/popular-topics/error-handling/ping-cooldown-error.json";
...
<NewDiscordComponent messages={[FeedbackResponsePayload, FeedbackUserMessagePayload, FeedbackThanksPayload]} />

<br />

Otherwise, if you don't respond in time, the interaction will go as follows:

<NewDiscordComponent messages={[FeedbackTimeoutResponsePayload, FeedbackTimeoutErrorPayload]} />
...
<NewDiscordComponent messages={[SecretOwnerResponsePayload]} />

<br />

Any other user whose ID doesn't match the bot owner's will get the following:

<NewDiscordComponent messages={[SecretNonOwnerResponsePayload]} />
...
<NewDiscordComponent messages={[AvatarDmUserMsgPayload, AvatarDmResponsePayload]} />

<br />

Otherwise, if used in a guild context:

<NewDiscordComponent messages={[AvatarGuildUserMsgPayload, AvatarGuildErrorPayload]} />
...
<NewDiscordComponent messages={[PingCooldownFirstPayload, PingCooldownErrorPayload]} />
...
- [Our Cogs Guide Page](/popular-topics/cogs/)
