...
description: Learn how to record audio from voice channels in Pycord
---
...
import RecordResponsePayload from "$payloads/voice/receiving-record-response.json";
import FinishedRecordingPayload from "$payloads/voice/receiving-finished-recording.json";
...
<NewDiscordComponent messages={[RecordResponsePayload]} />
...
<NewDiscordComponent messages={[FinishedRecordingPayload]} />
