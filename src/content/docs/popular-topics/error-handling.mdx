...
<DiscordComponent>
    <discord-message profile="robocord">
        <discord-command slot="reply" profile="dorukyum" command="/feedback"></discord-command>
        Hey, Dorukyum! Send your feedback within the next 30 seconds please!
    </discord-message>
    <discord-message profile="dorukyum">Great bot!</discord-message>
    <discord-message profile="robocord">
...
<DiscordComponent>
    ...
    <discord-message profile="robocord">Timed out, please try again!</discord-message>
</DiscordComponent>
...
<DiscordComponent>
    <discord-message profile="robocord">
        <discord-command slot="reply" profile="dorukyum" command="/secret"></discord-command>
...
<DiscordComponent>
    <discord-message profile="robocord">
        <discord-command slot="reply" profile="bob" command="/secret"></discord-command>
...
<DiscordComponent>
  <discord-message profile="bob">
    !avatar
  </discord-message>

  <discord-message profile="robocord">
    <discord-reply slot="reply" profile="bob" highlight>
      !avatar
    </discord-reply>

    <discord-embed slot="embeds" embed-title="Avatar" url="/avatar/bob.webp" border-color="#5865F2">
