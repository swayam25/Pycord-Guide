...
import PycordGuideEmbedPayload from "$payloads/getting-started/more-features-pycord-guide-embed.json";
import EmbedPayload from "$payloads/getting-started/more-features-embed.json";
...
<NewDiscordComponent messages={[PycordGuideEmbedPayload]} />
...
<NewDiscordComponent messages={[EmbedPayload]} />
