...
description: Learn how to host your Discord bot online so it stays running 24/7.
---

import { Aside, TabItem, Tabs } from "@astrojs/starlight/components";

If you're completely new to this, you might have thought something along the lines of "Yay! I got my bot working," after following our [Creating your First Bot](/getting-started/creating-your-first-bot/) guide, only to close your IDE or shut down your computer to find your bot offline.
...
<TabItem label="Shared Hosting">
    Shared hosting is a type of hosting where multiple people share one VPS. Getting a spot on a shared host is usually cheap, sometimes even free.
    Shared hosts do not give you a lot of resources, from less than a gigabyte of RAM (usually 512MB on free hosts) and half of a CPU with very little
    storage. Shared hosting is usually used for website hosting and is not recommended for hosting a Discord bot.
</TabItem>

  <TabItem label="Dedicated">
    A dedicated host is a physical computer. You can buy these yourself or rent one from a hosting provider. Dedicated hosts are often very expensive, but are also very powerful, having a few hundred gigabytes of RAM and a few very powerful CPUs, along with a good amount of storage. Dedicated hosts are usually used for very large projects and are overkill for something like a Discord bot.
  </TabItem>
</Tabs>

<Aside type="danger">
    Make sure you choose a hosting provider you trust. Also make sure the hosting provider you're looking at has good reviews on public forums.
    Googling along the lines of "[host] review" should do the trick. A provider you don't trust can compromise your token.
</Aside>
...
<Aside type="caution">
    If you are using SSH to run the file, your bot will not stay running. This is because the file is only told to run during your session. You can
    use a command like [nohup](https://en.wikipedia.org/wiki/Nohup) to make sure your file stays running after you disconnect.
</Aside>
...
- [Creating Your First Bot](/getting-started/creating-your-first-bot/)
