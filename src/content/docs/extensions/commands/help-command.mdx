---
title: Help Command
description: Learn how to create custom help commands for your Pycord bot
---
...
import PrefixedHelpDefaultResponse from "$payloads/extensions/commands/help-default-response.json";
import PrefixedHelpMinimalResponse from "$payloads/extensions/commands/help-minimal-response.json";
import PrefixedHelpMinimalEmbed from "$payloads/extensions/commands/help-minimal-embed.json";
import PrefixedHelpErrorEmbed from "$payloads/extensions/commands/help-error-embed.json";
import PrefixedHelpUserMsgErrorEmbed from "$payloads/extensions/commands/help-error-user-msg.json";
...
<Tabs>
  <TabItem label="Default Help Command">
    ```py title="Default Help Command"
    import discord
  ...
  <TabItem label="Minimal Help Command">
    ```py title="Minimal Help Command"
    import discord
    from discord.ext import commands
...
```py title="Minimal Help Command Example"
...
<NewDiscordComponent messages={[[PrefixedHelpUserMsgPayload], [PrefixedHelpMinimalEmbed]]} />
...
```py title="Improved Bot Help Example"
class MyHelp(commands.HelpCommand):
...
```py title="Custom Cog Help Example"
class MyHelp(commands.HelpCommand):
    def get_command_signature(self, command):
        return '%s%s %s' % (self.context.clean_prefix, command.qualified_name, command.signature)
...
```py title = "Custom Group Help Example"
class MyHelp(commands.HelpCommand):
    def get_command_signature(self, command):
        return '%s%s %s' % (self.context.clean_prefix, command.qualified_name, command.signature)
...
<details>
  ...
  <div class="markdown-body">
    ...
    ```py title="Custom Help Command Example"
...
```py title="Help Command Attributes"
attributes = {
   'name': "help",
   'aliases': ["helpme"],
...
```py title="Custom Help Error Example"
class MyHelp(commands.HelpCommand):
...
<NewDiscordComponent messages={[[PrefixedHelpUserMsgErrorEmbed], [PrefixedHelpErrorEmbed]]} />
