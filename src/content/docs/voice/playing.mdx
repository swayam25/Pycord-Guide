...
description: Learn how to play audio using Wavelink in Pycord
---
...
import NowPlayingPayload from "@payloads/voice/playing-now-playing.json";
...
<NewDiscordComponent messages={[NowPlayingPayload]} />
