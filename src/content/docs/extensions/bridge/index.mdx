...
<NewDiscordComponent messages={[[HelloSlashResponsePayload], [HelloPrefixedUserMsgPayload], [HelloPrefixedResponsePayload]]} />
...
<NewDiscordComponent messages={[[SumSlashResponsePayload], [SumPrefixedUserMsgPayload], [SumPrefixedResponsePayload]]} />
