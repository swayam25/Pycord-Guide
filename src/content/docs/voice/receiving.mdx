...
<DiscordComponent>
    <discord-message profile="robocord">
        <discord-command slot="reply" profile="bob" command="/record"></discord-command>
        Started recording!
    </discord-message>
</DiscordComponent>
...
<DiscordComponent>
    <discord-message profile="robocord">
        finished recording audio for: <discord-mention highlight={true}>BobDotCom</discord-mention>
    </discord-message>
</DiscordComponent>
