...
<DiscordComponent messages={[FeedbackResponsePayload, FeedbackUserMessagePayload, FeedbackThanksPayload]} />

<br />

Otherwise, if you don't respond in time, the interaction will go as follows:

<DiscordComponent messages={[FeedbackTimeoutResponsePayload, FeedbackTimeoutErrorPayload]} />
...
<DiscordComponent messages={[SecretOwnerResponsePayload]} />

<br />

Any other user whose ID doesn't match the bot owner's will get the following:

<DiscordComponent messages={[SecretNonOwnerResponsePayload]} />
...
<DiscordComponent messages={[AvatarDmUserMsgPayload, AvatarDmResponsePayload]} />

<br />

Otherwise, if used in a guild context:

<DiscordComponent messages={[AvatarGuildUserMsgPayload, AvatarGuildErrorPayload]} />
...
<DiscordComponent messages={[PingCooldownFirstPayload, PingCooldownErrorPayload]} />
