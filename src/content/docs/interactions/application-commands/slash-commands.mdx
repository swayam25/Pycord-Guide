...
import PingPayload from "../../../../payloads/interactions/application-commands/slash-commands-ping.json";
import AddPayload from "../../../../payloads/interactions/application-commands/slash-commands-add.json";
import JoinPayload from "../../../../payloads/interactions/application-commands/slash-commands-join.json";
import AnimalPayload from "../../../../payloads/interactions/application-commands/slash-commands-animal.json";
...
<Aside type="danger">
    Remember that Slash Commands require your bot to be invited with the `application.commands` scope or Slash Commands will not show up. Bots already
    in the guild can simply be invited again with the scope; there is no need to kick the bot.
</Aside>
...
<NewDiscordComponent messages={[PingPayload]} />
...
![Picture of the subcommands in the Slash Command Menu](@images/interactions/groups-and-subcommands.webp)

You'll notice that there's the name of the Slash Command Group and then the name of the subcommand separated by a space.

<Aside type="tip">If you are looking to add Slash Command Groups to cogs, please look at our [Cogs page](/popular-topics/cogs/)!</Aside>
...
<Tabs>
  <TabItem label="Using Type Annotations">
    ...
    <DiscordComponent>
      <discord-message profile="robocord">
        <discord-command slot="reply" profile="bob" command="/add"></discord-command>
        The sum of 1 and 1 is 2.
      </discord-message>
      <discord-message profile="robocord">
        <discord-command slot="reply" profile="bob" command="/join"></discord-command>
...
<DiscordComponent>
    <discord-message profile="robocord">
        <discord-command slot="reply" profile="bob" command="/animal"></discord-command>
        You picked an animal type of <code>Marine</code> that led you to pick <code>Shark</code>!
    </discord-message>
</DiscordComponent>

<Aside type="caution">Autocomplete can **only** be used with slash commands.</Aside>
