...
<discord-message profile="bob">!hello</discord-message>

  <discord-message profile="robocord">
    <discord-reply slot="reply" profile="bob" highlight>!hello</discord-reply>
...
<DiscordComponent>
    ...
    <discord-message profile="robocord">
        <discord-command slot="reply" profile="bob" command="/bye"></discord-command>
        Bye!
    </discord-message>
    <discord-message profile="bob">!bye</discord-message>
    <discord-message profile="robocord">
        <discord-reply slot="reply" profile="bob" highlight>
            !bye
        </discord-reply>
...
<DiscordComponent>
  <discord-message profile="robocord">
    <discord-command slot="reply" profile="bob" command="/sum"></discord-command>

    4

  </discord-message>

<discord-message profile="bob">!sum 2 2</discord-message>

  <discord-message profile="robocord">
    <discord-reply slot="reply" profile="bob" highlight>!sum 2 2</discord-reply>
