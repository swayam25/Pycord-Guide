...
<Aside type="tip">
    Not all the methods and attributes will be covered in this guide, but you can find them in our documentation! [Check it
    out!](https://docs.pycord.dev/en/stable/api/models.html#discord.Thread)
</Aside>
...
```py title="Creating a Thread from a Message"
...
```py title="Creating a Thread from a Channel"
